...
class achivementThisMonth extends StatefulWidget {
  const achivementThisMonth({super.key});
  _achivementThisMonthState createState() => _achivementThisMonthState();
}

class _achivementThisMonthState extends State<achivementThisMonth> {
  @override
  ...
  void initState() {
    super.initState();
    _selectedOption = _options[2]; // Set initial value to the first option
  }
